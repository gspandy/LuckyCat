package com.jesse.util.core.metatype.impl;


import com.jesse.util.CalendarUtils;
import com.jesse.util.core.metatype.Dto;
import com.jesse.util.core.util.BL3Constants;
import com.jesse.util.core.util.JsonHelper;
import com.jesse.util.core.util.TypeCaseHelper;
import com.jesse.util.core.util.XmlHelper;
...
public class BaseDto extends HashMap implements Dto, Serializable {
	...
	public Date getAsDate(String key) throws ParseException {
		...
		if (obj != null)
			return CalendarUtils.parseDate(obj.toString());
		else
			return null;
	}
	...
	public String toXml(String pStyle) {
		String strXml = null;
		if (pStyle.equals(BL3Constants.XML_Attribute))
			// 节点属性值风格
			strXml = XmlHelper.parseDto2Xml(this, "root", "row");
		else if (pStyle.equals(BL3Constants.XML_Node))
			// 节点元素值风格
