package com.jesse.util.core.util;
...
public class BL3Utils {
	...
	/**
	 * @description：hashMap转换为dto
	 * @author：MICK
	 * @date:2015年11月18日 下午6:01:08
	 * @param map
	 * @param pToDto
	 */
	public static void hashMap2Dto(Map map, Dto pToDto){
	 ...
	 * @return
	 */
	public static Dto iterateSetChildren(List list, Dto parent) {
		...
		while (iterator.hasNext()) {
			...
			if (next.getAsString("parentid").equals(parent.getAsString("id"))) {
				if (parent.getAsList("children") == null) {
					parent.put("children", new ArrayList<Dto>());
				}
	 ...
	 * @param dto
	 */
	public static void handleNullStr(Dto dto) {
		if (dto != null) {
